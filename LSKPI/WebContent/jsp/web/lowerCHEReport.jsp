...
<body onload="checkMessage('${message}')">
    ...
    <div data-role="page" id="home">
        ...
        <iframe src="${cheReportFile}" id="iframepage" scrolling="no" width="100%" onload="javascript:dyniframesize('iframepage');"></iframe>
        <jsp:include page="page_footer.jsp">
            <jsp:param value="<%=basePath%>" name="basePath"/>
            <jsp:param value="ratioLastweekChe" name="backURL"/>
        </jsp:include>
    </div>
</body>  
</html>  