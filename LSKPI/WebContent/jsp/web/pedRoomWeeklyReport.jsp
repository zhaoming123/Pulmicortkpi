...
<body onload="checkMessage('${message}')">
    ...
    <div data-role="page" id="home">
        <jsp:include page="page_header.jsp" flush="true">
            <jsp:param name="title" value="儿科住院每周报告"/>
            <jsp:param name="basePath" value="<%=basePath%>"/>
        </jsp:include>
        <iframe src="${pedRoomReportFile}" id="iframepage" scrolling="no" width="100%" onload="javascript:dyniframesize('iframepage');"></iframe>
